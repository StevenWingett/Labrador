...
$labrador_url = 'http://debono-pc-26.lmb.internal:8000';
$data_alias   = '';
...
$support_email = 'swingett@mrc-lmb.cam.ac.uk';
...
$administrators = array(
	'steven.wingett@mrc-lmb.cam.ac.uk' => 'Steven Wingett'
);
...
$processing_servers = array(
	'server1' => array('name' => 'Server 1', 'queueing' => 'true'),
	'server2' => array('name' => 'Server 2', 'queueing' => 'false')
);
...
$processing_codes = array(
	'cf_download' => array(
		'server1' => "{{sra_url}}\t{{fn}}.sra",
		'server2' => "{{sra_url}}\t{{fn}}.sra"
	),
	'get_sra' => array(
		'server1' => 'echo "wget -nv {{sra_url_wget}}" | qsub -V -cwd -pe orte 1 -l vf=1G -o {{fn}}_download.out -j y -m as -M {{assigned_email}} -N download_{{fn}}',
		'server2' => 'wget -nv {{sra_url_wget}}'
	),
	'sra_dump' => array(
		'server1' => 'echo "fastq-dump --split-files ./{{fn}}.sra" | qsub -V -cwd -pe orte 1 -l vf=4G -o {{fn}}_fqdump.out -j y -m as -M {{assigned_email}} -N dump_{{fn}} -hold_jid download_{{fn}}',
		'server2' => 'fastq-dump --split-files ./{{fn}}.sra'
	),
	'fastqc' => array(
		'server1' => 'echo "fastqc  {{fn}}_1.fastq" | qsub -V -cwd -pe orte 1 -l vf=4G -o {{fn}}_1_fastqc.out -j y -m as -M {{assigned_email}} -N fastqc_{{fn}}_1 -hold_jid dump_{{fn}}',
		'server2' => 'fastqc {{fn}}_1.fastq'
	),
	'fastq_screen' => array(
		'server1' => 'echo "fastq_screen --subset 100000 {{fn}}_1.fastq" | qsub -V -cwd -pe orte 1 -l vf=4G -o {{fn}}_1_fqscreen.out -j y -m as -M {{assigned_email}} -N screen_{{fn}}_1 -hold_jid dump_{{fn}}',
		'server2' => 'fastq_screen --subset 100000 {{fn}}_1.fastq'
	),
	'trim_galore_se' => array(
		'server1' => 'echo "trim_galore --fastqc {{fn}}_1.fastq" | qsub -V -cwd -pe orte 2 -l vf=4G -o {{fn}}_trimming.out -j y -m as -M {{assigned_email}} -N trim_{{fn}} -hold_jid dump_{{fn}}',
		'server2' => 'trim_galore --fastqc {{fn}}_1.fastq'
	),
	'trim_galore_pe' => array(
		'server1' => 'echo "trim_galore --paired --trim1 --fastqc {{fn}}_1.fastq {{fn}}_2.fastq" | qsub -V -cwd -pe orte 2 -l vf=4G -o {{fn}}_trimming.out -j y -m as -M {{assigned_email}} -N trim_{{fn}} -hold_jid dump_{{fn}}',
		'server2' => 'trim_galore --paired --trim1 --fastqc {{fn}}_1.fastq {{fn}}_2.fastq'
	),
	'bowtie1_se' => array(
		'server1' => 'echo "bowtie -q -t -p 8 -m 1 --best --strata --chunkmbs 2048 -S {{genome_path}} {{fn}}_1_trimmed.fq | samtools view -bS - > {{fn}}_1.bam" | qsub -V -cwd -l vf=4G -pe orte 8 -o {{fn}}_alignment.out -j y -m as -M {{assigned_email}} -N bowtie_{{fn}} -hold_jid trim_{{fn}}',
		'server2' => 'bowtie -q -m 1 -p 4 --best --strata --chunkmbs 512 -S {{genome_path}} {{fn}}_1_trimmed.fq | samtools view -bS - > {{fn}}_1.bam'
	),
	'bowtie1_pe' => array(
		'server1' => 'echo "bowtie -q -t -p 8 -m 1 --chunkmbs 2048 -S {{genome_path}} -1 {{fn}}_1_trimmed.fq -2 {{fn}}_2_trimmed.fq | samtools view -bS - > {{fn}}.bam" | qsub -V -cwd -l vf=4G -pe orte 8 -o {{fn}}_alignment.out -j y -m as -M {{assigned_email}} -N bowtie_{{fn}} -hold_jid trim_{{fn}}',
		'server2' => 'bowtie -q -m 1 -p 4 --chunkmbs 512 -S {{genome_path}} -1 {{fn}}_1_val_1.fq -2 {{fn}}_2__val_2.fq | samtools view -bS - > {{fn}}.bam'
	),
	'tophat_se' => array(
		'server1' => 'echo "tophat -g 1 -p 4 -o {{fn}}_tophat -G {{genome_path}}.cleaned.gtf {{genome_path}} {{fn}}_1_trimmed.fq" | qsub -V -cwd -l vf=4G -pe orte 4 -o {{fn}}_tophat.out -j y -m as -M {{assigned_email}} -N tophat_{{fn}} -hold_jid trim_{{fn}}',
		'server2' => 'tophat -g 1 -p 4 --segment-length 42 -o {{fn}}_tophat -G {{genome_path}}.cleaned.gtf {{genome_path}} {{fn}}_1_trimmed.fq'
	),
	'tophat_pe' => array(
		'server1' => 'echo "tophat -g 1 -p 4 -o {{fn}}_tophat -G {{genome_path}}.cleaned.gtf {{genome_path}} {{fn}}_1_val_1.fq {{fn}}_2_val_2.fq" | qsub -V -cwd -l vf=4G -pe orte 4 -o {{fn}}_tophat.out -j y -m as -M {{assigned_email}} -N tophat_{{fn}} -hold_jid trim_{{fn}}',
		'server2' => 'tophat -g 1 -p 4 --segment-length 42 -o {{fn}}_tophat -G {{genome_path}}.cleaned.gtf {{genome_path}} {{fn}}_1_val_1.fq {{fn}}_2_val_2.fq'
	),
	'bismark_se' => array(
		'server1' => 'echo "bismark --bam {{genome_path}} {{fn}}_1_trimmed.fq" | qsub -V -cwd -l vf=12G -pe orte 6 -o {{fn}}_bismark_run.out -j y -m as -M {{assigned_email}} -N bismark_{{fn}} -hold_jid trim_{{fn}}',
		'server2' => 'bismark --bam {{genome_path}} {{fn}}_1_trimmed.fq'
	),
	'bismark_pe' => array(
		'server1' => 'echo "bismark --bam {{genome_path}} -1 {{fn}}_1_val_1.fq -2 {{fn}}_2_val_2.fq" | qsub -V -cwd -l vf=12G -pe orte 6 -o {{fn}}_bismark_run.out -j y -m as -M {{assigned_email}} -N bismark_{{fn}} -hold_jid trim_{{fn}}',
		'server2' => 'bismark --bam {{genome_path}} -1 {{fn}}_1_val_1.fq -2 {{fn}}_2_val_2.fq'
	),
	'bismark_pbat' => array(
		'server1' => 'echo "bismark --pbat –bam {{genome_path}} {{fn}}_1_trimmed.fq" | qsub -V -cwd -l vf=12G -pe orte 6 -o {{fn}}_bismark_run.out -j y -m as -M {{assigned_email}} -N bismark_{{fn}} -hold_jid trim_{{fn}}',
		'server2' => 'bismark --pbat –bam {{genome_path}} {{fn}}_1_trimmed.fq'
	),
	'email_assigned' => array(
		'server1' => 'echo "{{project}} Processing Completed at {{time}}" | qsub -V -cwd -pe orte 1 -l vf=1G -o {{project}}_email.out -j y -N email_{{project}} -m eas -M {{assigned_email}} {{hold_prev}}',
		'server2' => 'echo "{{project}} Processing Completed at {{time}}" | mail -s "{{project}} Processing Complete" {{assigned_email}}'
	)
);
...
$genomes = array (
	'Mouse - NCBIM37' => array(
		'server1' => '/bi/scratch/Genomes/Mouse/NCBIM37/Mus_musculus.NCBIM37',
		'server2' => '/data/public/Genomes/Mouse/NCBIM37/Mus_musculus.NCBIM37'
	),
	'Mouse - GRCm38' => array(
		'server1' => '/bi/scratch/Genomes/Mouse/GRCm38/Mus_musculus.GRCm38',
		'server2' => '/data/public/Genomes/Mouse/GRCm38/Mus_musculus.GRCm38'
	),
	'Human - GRCh37' => array(
		'server1' => '/bi/scratch/Genomes/Human/GRCh37/Homo_sapiens.GRCh37',
		'server2' => '/data/public/Genomes/Human/GRCh37/Homo_sapiens.GRCh37'
	)
);
